...
for lang in os.listdir("/projects/tir2/users/cmalaviy/bible-corpus/combined_bible_only_tok/"):
    ...
    print("python /home/rrjin/anaconda3/envs/ml/lib/python3.7/site-packages/subword_nmt/apply_bpe.py -c /projects/tir2/users/cmalaviy/bible-corpus/combined-bible-only-bpe.tok < /projects/tir2/users/cmalaviy/bible-corpus/combined_bible_only_tok/"+lang+filename_lang+" > /projects/tir2/users/cmalaviy/bible-corpus/combined_bible_only_tok_bpe/"+lang+filename_lang[:-4]+".bpe.txt")
    call("python /home/rrjin/anaconda3/envs/ml/lib/python3.7/site-packages/subword_nmt/apply_bpe.py -c /projects/tir2/users/cmalaviy/bible-corpus/combined-bible-only-bpe.tok < /projects/tir2/users/cmalaviy/bible-corpus/combined_bible_only_tok/"+lang+filename_lang+" > /projects/tir2/users/cmalaviy/bible-corpus/combined_bible_only_tok_bpe/"+lang+filename_lang[:-4]+".bpe.txt", shell=True)
